...
def getLightSettingsEntry(light: MMLight, lightMode: str, isLightingCustom: bool, index: int):
    vectors = [
...
def getSceneModel(outScene: MMScene, textureExportSettings: TextureExportSettings) -> CData:
    return outScene.model.to_c(textureExportSettings, MMGfxFormatter(ScrollMethod.Vertex)).all()


#############
# Exit List #
#############
def getExitList(outScene: MMScene, headerIndex: int):
    exitList = CData()
...
# Room List #
#############
def getRoomList(outScene: MMScene):
    roomList = CData()
...
# Scene Header #
################
def getHeaderData(header: MMScene, headerIndex: int):
    headerData = CData()
...
def getSceneData(outScene: MMScene):
    sceneC = CData()

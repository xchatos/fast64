...
mmEnumCSActorCueListCommandType = [
    item for item in mmData.enumData.mmEnumCsCmd if "actor_cue" in item[0] or "player_cue" in item[0]
]
mmEnumCSActorCueListCommandType.sort()
mmEnumCSActorCueListCommandType.insert(0, ("Custom", "Custom", "Custom"))
...
mmCSMotionListAndSingleCommands = mmCSMotionSingleCommands + mmCSMotionListCommands
mmCSMotionListAndSingleCommands.remove("CS_BEGIN_CUTSCENE")
mmCSMotionCSCommands = mmCSMotionSingleCommands + mmCSMotionListCommands + mmCSMotionListEntryCommands

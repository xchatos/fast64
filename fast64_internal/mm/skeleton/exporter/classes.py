...
class MMLimb:
    def __init__(
        ...
        DL: GfxList | MMDLReference,
        lodDL: GfxList | MMDLReference,
    ):
    ...
    def getList(self, limbList):
        # Like mmProcessBone, this must be in depth-first order to match the
        # Mm SkelAnime draw code, so the bones are listed in the file in the
